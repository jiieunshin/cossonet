...
data_generation = function(n, p, rho, SNR,
  ...
  # if(response == "classification"){
    ...
    # f4 = function(t) 0.1*sin(2 * pi * t) + 0.2*cos(2 * pi * t) + 0.3*sin(2 * pi * t)^2 + 0.4*cos(2 * pi * t)^3 + 0.5*sin(2 * pi * t)^3 - 0.4 - 0.4
  ...
  f = 5 * f1(x[,1]) + 3 * f2(x[,2]) + 4 * f3(x[,3]) + 6 * f4(x[,4]) + 2 * f5(x[,5])
  # print(f)
  V_sig = var(5 * f1(x[,1])) + var(3 * f2(x[,2])) + var(4 * f3(x[,3])) + var(6 * f4(x[,4])) + var(2 * f5(x[,5]))
  sd = sqrt(var(f) / SNR)
